...
class dds(_algorithm):
    ...
    def sample(self, repetitions, trials=1, x_initial=np.array([]), init_iter_num=0):
        ...
        for trial in range(trials):
            ...
            print('repetition left:', self.generator_repetitions)
            self.params_max = params_max
            for rep, x_curr, simulations in self.repeat(self.get_next_x_curr(init_iter_num)):
    ...
    def calculate_next_s_test(self, previous_x_curr, rep, rep_limit, r):
        ...
        #
        print('rep, rep_limit and probability are:', rep, rep_limit, f'{probability_neighborhood:.4e}')
        #
